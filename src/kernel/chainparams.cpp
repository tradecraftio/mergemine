    ...
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        m_assumeutxo_data = {
            {   // For use by unit tests
                .height = 110,
                .hash_serialized = AssumeutxoHash{uint256{"2cfbe9757c9ca8d4a8ee4547f3a061f8e7e63bf2f04c58f5d5f9852f5768c8fd"}},
                .m_chain_tx_count = 121,
                .blockhash = consteval_ctor(uint256{"2a4bf27b9ad0add7201b208887e217958a31c5005d0b540a07ecd1dbb6f02e46"}),
            },
            {
            ...
            },
            {
                ...
                .height = 299,
                .hash_serialized = AssumeutxoHash{uint256{"75ec191885a97523d9f1d655041c7a4e36bd2a18cf51aa8adf8eb2066e87d999"}},
                .m_chain_tx_count = 533,
                .blockhash = consteval_ctor(uint256{"683c03c7f1dbab0cbcc6ec7000bfa5ee6623604765dcefa81322eec018503af2"}),
            },
        };
